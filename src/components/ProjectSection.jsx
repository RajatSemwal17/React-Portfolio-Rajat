  ...
  return (
    <section id="projects" className="py-24 px-4 relative">
      <div className="container mx-auto max-w-5xl">
        ...
        <h3 className="text-3xl md:text-4xl font-bold mb-4 text-center">Featured <span className="text-[oklch(0.85_0.37_145.52)]">Projects</span></h3>
              ...
              <div className="p-6">
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.tags.map((tag) => (
                    <span className="px-2 py-1 text-xs font-medium rounded-full border border-red-600 text-secondary">{tag}</span>
                  ))}
                </div>
                ...
                <div className="flex justify-between items-center">
                  <div className="flex space-x-3">
                    <a
                      ...
                      target="_blank"
                      className="text-foreground/80 hover:text-[oklch(0.85_0.37_145.52)] transition-colors duration-300"
                    >
        ...
        <div className="text-center mt-12">
          <a className="cosmic-button w-fit flex items-center mx-auto gap-2" target="_blank" href="https://github.com/RajatSemwal17">
